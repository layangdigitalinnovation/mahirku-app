...
export interface CSTCertificateData {
  ...
  resultTitle: string; // e.g. "Bold Visionary"
  resultSubtitle: string; // e.g. "Visionary-E"
  score: string; // e.g. "91%"
  summary: string;
  brainProcess: string;
  traits: string[];
...
export const generateCSTCertificatePDF = async (data: CSTCertificateData) => {
  ...
  const codeMatch = data.resultSubtitle.match(/Analyzer-I|Empath-E|Observer-I|Observer-E|Empath-I|Visionary-E|Visionary-I|Analyzer-E|Navigator/);
  const code = codeMatch ? codeMatch[0] : 'Navigator';
  const colorKey = colorMap[code] || 'indigo';
...
<body>
                        ...
                        <div class="flex items-center justify-between border-b pb-4 mb-5">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500">Cognitive Style (9 Dimensions Mapping)</p>
                                </div>
                            </div>
                            <div class="text-right">
                    ...
                    <td class="pb-8 px-10">
                        <div class="mt-8 pt-3 border-t border-slate-100 flex items-start gap-2.5 avoid-break">
                            ...
                            <p class="text-[10px] text-slate-400 leading-relaxed">
                                <strong>Disclaimer:</strong> Hasil ini merupakan pemetaan dimensi kognitif beserta spektrum Ekstroversi/Introversi. Laporan ini dirancang untuk pemetaan bakat karir digital dan metode kolaborasi, bukan merupakan diagnosis psikologis klinis.
                            </p>
                        </div>
                    </td>
                </tr>
  ...
  try {
    ...
    console.error('Error generating CST certificate:', error);
    throw error;
  }
};
