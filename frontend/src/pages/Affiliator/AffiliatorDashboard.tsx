...
export const AffiliatorDashboard: React.FC = () => {
  const { data: referralData, isLoading: referralLoading, isError: referralError } = useReferralLink();
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats?.statistics?.totalTests || 0}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className='bg-white'>
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">Token Purchases</p>
                  <p className="text-2xl font-bold text-gray-900">{stats?.statistics?.totalTokenPurchaseCommissions || 0}</p>
                </div>
              </div>
            </CardContent>
          </Card>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          ...
                          {commission.source === 'test_completion' ? 'Test Completion' : 'Token Purchase'}
                          {commission.referredUser && ` • ${commission.referredUser.fullname}`}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className={`px-2 py-1 capitalize text-xs rounded-full ${
            ...
            <CardContent>
              <div className="space-y-4">
                {stats.recentWithdraws.map((withdraw: any) => (
                  <div key={withdraw.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-4">
                      <div className="flex-shrink-0">
