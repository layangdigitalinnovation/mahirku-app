    ...
    <div className="bg-white">
      ...
      <section className="bg-secondary-100 font-body text-white py-40">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-heading1 text-primary-900 font-bold mb-4 font-heading">Hubungi Kami</h1>
      ...
      <section className="py-20 bg-gray-50 font-body">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-gray-900 font-heading">Informasi Kontak</h2>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-blue-100">
            <h3 className="text-2xl font-semibold text-gray-900 mb-6 font-heading">Kirim Pesan</h3>
